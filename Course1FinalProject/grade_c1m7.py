...
if __name__ == '__main__':
    ...
    waypoint_file = "racetrack_waypoints.txt"
    waypoints = np.genfromtxt(waypoint_file, delimiter=',')
    
    #solution_file = files[2]
    solution_file = "/home/munir/Documents/CarlaSimulator/PythonClient/Course1FinalProject/controller_output/trajectory.txt"
